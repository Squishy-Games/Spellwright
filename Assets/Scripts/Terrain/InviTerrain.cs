...
public class InviTerrain : MonoBehaviour
{
	...
	public class TerrainChunk 
	{
		...
		void OnMapDataReceived(MapData mapData) 
		{
			...
			Texture2D texture = TextureGen.TextureFromColourMap(mapData.colorMap, MapGen.mapChunkSize, MapGen.mapChunkSize);
		...
		public void UpdateTerrainChunk() 
		{
			if (mapDataReceived)
			{
				...
				if (visible) 
				{
					...
					if (lodindex != perviousLODIndex) 
					{
						LODMesh lodMesh = lodMeshes[lodindex];
						if (lodMesh.HasMesh) 
						{
							perviousLODIndex = lodindex;
